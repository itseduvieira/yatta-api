...
app.use(function (req, res, next) {
    ...
    res.set('Access-Control-Expose-Headers', 'Access-Control-Allow-Origin,x-access-token,x-access-token-secret,x-auth-uid')

    res.setHeader('Access-Control-Allow-Origin', '*')

    res.setHeader('Access-Control-Allow-Methods', 'GET, POST, OPTIONS, PUT, PATCH, DELETE')

    res.setHeader('Access-Control-Allow-Headers', 'X-Requested-With,content-type,x-access-token,x-access-token-secret,x-auth-uid')
